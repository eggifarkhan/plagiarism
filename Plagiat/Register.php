	...
	<div class="container">
		<form action="" method="POST" class="login-email">
			...
			<div class="input-group">
				<input type="text" placeholder="Masukan Nim" name="nim" value="<?php echo $nim; ?>" required>
			</div>
			<div class="input-group">
				<input type="text" placeholder="Masukan Nama" name="nama" value="<?php echo $nama; ?>" required>
			</div>
