...
include "config.php";
    $id = $_GET['id_admin'];
    $ambil = mysqli_query($conn,"SELECT * FROM admin WHERE id_admin='$id'");
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo "<h10>Admin " . $_SESSION['nama'] . "</h10>"; ?></span>
...
if(isset($_POST['submit'])){
    ...
    SET nama='$nama', email='$email', password='$password' WHERE id_admin='$id' ")
