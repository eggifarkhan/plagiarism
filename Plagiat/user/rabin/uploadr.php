...
<body id="page-top">
    ...
    <label  class="col-sm-2 control-label">File Source</label>
    <div class="col-sm-10">
    <input type="file" name="source" rows="10"/>
    </div>
  </div>    
  </br>
...
<button class="btn btn-primary" type="submit" name="readpdf">Proses Algoritma Rabin Karp</button>
        </form>
        </p>
