...
<h1>Algoritma Winnowing</h1>
        <p>Algoritma winnowing adalah salah satu algoritma yang dapat mendeteksi kemiripan teks dengan menggunakan metode fingerprint.</p>
        <p>
<form method="post" enctype="multipart/form-data" action="read_file.php">
        Masukan Data yang ingin diperiksa<p>
        <input type="file" name="file" />
        <br><br>
        <input type="submit" class="btn btn-success" value="Submit" name="readpdf" />
    </form>
</div>
